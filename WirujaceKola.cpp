...
// WirujaceKola.cpp: definiuje zachowania klasy dla aplikacji.
//
...
BEGIN_MESSAGE_MAP(CWirujaceKolaApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Konstrukcja klasy CWirujaceKolaApp

CWirujaceKolaApp::CWirujaceKolaApp()
{
...
// Jedyny obiekt CWirujaceKolaApp

CWirujaceKolaApp theApp;


// Inicjowanie klasy CWirujaceKolaApp

BOOL CWirujaceKolaApp::InitInstance()
{
